...
import { Zodit } from './include.zodit';
const { isFunction } = Zodit.modules.Helpers;

const ZoditEditor = forwardRef(
	(
		...
		useEffect(() => {
			...
			textArea.current = Zodit.make(element, config);
		...
		return (
			<div className={'zodit-react-container'}>
...
ZoditEditor.displayName = 'ZoditEditor';

ZoditEditor.propTypes = {
	config: object,
	id: string,
	name: string,
	onBlur: func,
